...
public abstract class SignalRConnectionBase {
    ...
    private void onReconnected() {
        this.logger.logInformation(String.format("Reconnected error. exception\n"));
        this.logger.logInformation("Reconnected. hubconn=" + this.hubConnection.getUrl());
    }

    private void onConnectionClosed() {
        this.logger.logInformation(String.format("Closed error. exception\n"));
    ...
    private void onConnectionError(Throwable e) {
        this.logger.logInformation(String.format("Connection error. exception\n"));
        ...
        if (e != null) {
            ...
            if (cause != null && cause.getMessage() != null) {
                ...
                } else if (msg.contains("keepAliveData cannot be null")) {
                    this.connectEvent.release();
                }
            }
        }
